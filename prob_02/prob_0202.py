passwords = [[['1-9'],['x:'],['xwjgxtmrzxzmkx']],
[['4-6'],['r:'],['rrrkrgr']],
[['4-5'],['v:'],['vvfvvvn']],
...
#     min_ = passwords[i][0][0]
#     min  = int(min_.split('-')[0])
#     max_ = passwords[i][0][0]
#     max  = int(max_.split('-')[1])
#     #print('{},{}'.format(min, max))
#     letter = passwords[i][1][0][0]
#     #print(letter)
#     pw = passwords[i][2][0]
...
for i in range(0, len(passwords)):
    x = int(passwords[i][0][0].split('-')[0])-1
    y = int(passwords[i][0][0].split('-')[1])-1
    letter = passwords[i][1][0][0]
    pw = passwords[i][2][0]
    if ((pw[x] == letter and pw[y] != letter) or (pw[x] != letter and pw[y] == letter)):
        total+=1
